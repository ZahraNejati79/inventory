  ...
  return (
    <div className="flex-col justify-center py-6 rounded-lg pb-2 mt-2 w-5/6 md:w-1/2 md:max-w-xl md:text-xl">
      <div className="flex justify-between items-center w-full mb-2 ">
        <input
          onChange={onSearch}
          className=" text-right w-full dark:bg-slate-800 dark:text-white rounded-lg placeholder:text-gray-300 placeholder:dark:text-gray-500 border-2 border-gray-300 dark:focus:border-slate-500 dark:border-slate-600 focus:border-gray-400 focus:border-transparent focus:ring-0 hover:border-2 hover:border-gray-400"
          type="text"
          placeholder=". . . . .جستوجو"
          value={search}
        />
